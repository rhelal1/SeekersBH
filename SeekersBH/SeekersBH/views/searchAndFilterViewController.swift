...
class searchAndFilterViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    private func setupTableView() {
        ...
        // Set row height
                searchTableView.rowHeight = 188  // Adjust this value as needed
                searchTableView.estimatedRowHeight = 188
    ...
    private func fetchJobs() {
        // Start refresh animation
                searchTableView.refreshControl?.beginRefreshing()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "searchFilterCell") as? jobCellTableViewCell else {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ShowJobDetails2",
